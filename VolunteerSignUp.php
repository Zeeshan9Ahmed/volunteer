        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="signup-form-two">
                    <form action="Controller/VolunteerSignUp.php" method="post" enctype="multipart/form-data">
                        <h2>Sign Up</h2>
                        <h6 style=" text-align: center; color: #fff700;">Sign Up as Organization   <a href="OrganizationSignUp.php" style=" text-align: center; color: #fff;">Here!</a> </h6>

                        <p>Please fill in this form to create an account!</p>

                        <div class="form-group hello">

                            <input type="text" class="form-control" name="name" placeholder="Volunteer Name"
                                required="required">
